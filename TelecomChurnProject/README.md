...
A end-to-end Business Analysis project investigating why customers leave a telecom company — and which customers are most at risk.
...
│   └── 5_churn_by_city.csv               ← Cities with highest churn
